...
import { getMinPhotosForCategory, getPhotoHintForCategory } from "../../../utils/sellFlowHelpers";
...
export default function Step3({
  ...
  const minPhotos = getMinPhotosForCategory(categoryType);
  const photoHint = getPhotoHintForCategory(categoryType);
    ...
    <div style={styles.container}>
      ...
      <div style={styles.buttonRow}>
        ...
        <button
          ...
          disabled={!canProceed}
        >
          {minPhotos === 0 ? "Next (photos optional)" : "Next"}
        </button>
      </div>
    </div>
  );
