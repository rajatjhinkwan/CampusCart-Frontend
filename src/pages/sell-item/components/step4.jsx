...
export default function Step4({ data = {}, onNext, onBack, categoryType, jobType }) {
  ...
  const [form, setForm] = useState({
    mode: data.mode || "Fixed", // Default to Fixed so price field is visible
    price: data.price || "",
  ...
  } else if (categoryType === "Transport") {
  ...
  return (
    <div style={styles.container}>
      ...
      <p style={styles.subheading}>
        {categoryType === "Job" ? "Job Details" : categoryType === "Room" ? "Room Details" : categoryType === "Service" ? "Service Details" : categoryType === "Transport" ? "Ride Pricing" : "Pricing Details"}
      </p>
      ...
      {categoryType === "Job" ? (
        ...
        <>
          <div style={styles.field}>
            <label style={styles.label}>Price per seat (₹) — optional</label>
            <input
              type="number"
              name="price"
