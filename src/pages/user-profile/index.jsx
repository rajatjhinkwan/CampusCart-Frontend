...
import { formatLocation } from "../../utils/formatDisplay";
...
const UserProfile = () => {
  ...
  useEffect(() => {
    const { checkedAuth, isAuthenticated: authed } = useUserStore.getState();
    ...
    try {
      ...
      if (res.data.success) {
        ...
        useUserStore.setState((state) => ({
          user: { ...state.user, ...updatedUser, avatar: avatarUrl || state.user?.avatar },
        }));
        ...
        <div style={styles.sidebar}>
            <div style={{ marginBottom: "20px", textAlign: "center", padding: "20px 0", borderBottom: "1px solid #f1f5f9" }}>
                <div style={{ width: "80px", height: "80px", margin: "0 auto 12px", borderRadius: "50%", overflow: "hidden", background: "#e2e8f0" }}>
                    <img src={resolveAvatarUrl(user.avatar) || "https://via.placeholder.com/150"} alt="User" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
                    ...
                    <div style={styles.profileHeader}>
                        ...
                        <div>
                            ...
                            <p style={{ color: "#64748b", display: "flex", alignItems: "center", gap: "6px" }}>
                                <MapPin size={16} /> {formatLocation(user.location)}
                            </p>
                        </div>
                    </div>
