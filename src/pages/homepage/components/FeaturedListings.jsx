          ...
          return (
            <div
              ...
              onClick={() => {
                ...
                else navigate("/browse?tab=Products");
              }}
              onMouseEnter={(e) => Object.assign(e.currentTarget.style, cardHover)}
              onMouseLeave={(e) => Object.assign(e.currentTarget.style, cardStyle)}
            >
              <img src={item.image || item.images?.[0]?.url || "https://picsum.photos/seed/featured/600/400"} alt={item.title} style={imageStyle} />
              ...
              <div style={contentStyle}>
                ...
                <p style={locationStyle}>
                  <i className="fa-solid fa-location-dot"></i> {formatLocation(item.location)}
                </p>

                <div style={tagBox}>
                  {(item.tags?.length
                    ? item.tags
                    : [{ text: formatCategory(item.category), bg: "#E0F2FE", color: "#0369A1" }]
                  ).map((tag, i) => (
