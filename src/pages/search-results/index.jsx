  ...
  return (
    <div style={styles.page}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "20px" }}>
        ...
        {/* Header Section with Notify Button */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
            <div>
                <h1 style={styles.header}>
                Search Results for "{q || "All Items"}"
                </h1>
                <p style={styles.sub}>
            ...
            {q && (
                <button
                    ...
                    style={{
                        ...
                        padding: "8px 16px",
                        borderRadius: "8px",
                        border: isNotifying ? "1px solid #2563eb" : "1px solid #e5e7eb",
                        background: isNotifying ? "#eff6ff" : "white",
                        color: isNotifying ? "#2563eb" : "#64748b",
                        cursor: "pointer",
                        fontWeight: "600",
                        fontSize: "14px",
                        transition: "all 0.2s"
                ...
                >
                    {isNotifying ? <Bell size={16} fill="currentColor" /> : <Bell size={16} />}
      ...
      <SearchFilterList products={items} loading={loading} error={error} type={activeTab} query={q} />
    </div>
  );
};
