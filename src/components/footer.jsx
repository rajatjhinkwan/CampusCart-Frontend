...
const Footer = () => {
  ...
  const linkGroups = [
    ...
    },
    {
      title: "Categories",
      links: [
        { name: "Vehicles", path: "/browse?tab=Products" },
        { name: "Real Estate", path: "/browse?tab=Rooms" },
        { name: "Electronics", path: "/browse?tab=Products" },
        { name: "Jobs", path: "/browse?tab=Jobs" },
        { name: "Services", path: "/browse?tab=Services" },
      ],
    },
    {
      title: "Company",
