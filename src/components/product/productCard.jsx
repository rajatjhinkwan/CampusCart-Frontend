  ...
  return (
    ...
    >
      ...
      <div style={styles.imageWrapper}>
        <img
          src={product.image || "https://picsum.photos/seed/product/400/300"}
          alt={product.title}
          style={styles.img}
          onError={(e) => {
            e.currentTarget.onerror = null;
            e.currentTarget.src = "https://picsum.photos/seed/product/400/300";
          }}
        />
      ...
      <div style={styles.content}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <div style={styles.seller}>
            <User size={12} /> {formatSeller(product.seller, product.companyName || "Seller")}
