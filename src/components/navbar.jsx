...
import showLoginToast from "../utils/showLoginToast.jsx";
      ...
      <nav style={styles.navbar}>
        <div style={styles.navContainer}>
          ...
          <div style={styles.rightSection}>
            ...
            {/* Sell Button - Visible to all but gated */}
            <button 
            ...
            {isLoggedIn ? (
              <>
                ...
                <div style={styles.profileWrapper} ref={profileRef}>
                  <img
                    src={resolveAvatarUrl(user?.avatar) || user?.image || "https://cdn-icons-png.flaticon.com/512/3135/3135715.png"}
