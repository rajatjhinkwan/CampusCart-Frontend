      ...
      <ErrorBoundary>
        ...
        <Suspense fallback={<LoadingFallback />}>
          <RouterRoutes>
            ...
            <Route path="/user-notifications" element={isAuthenticated ? <UserNotifications /> : <UserLogin />} />
            <Route path="/user-dashboard1" element={<UserDashboard1 />} />
            <Route path="/user-profile" element={isAuthenticated ? <UserProfile /> : <UserLogin />} />
            <Route path="/profile/:userId" element={<PublicProfile />} />
            <Route path="/browse" element={<Browse />} />
            <Route path="/rooms" element={<Browse />} />
